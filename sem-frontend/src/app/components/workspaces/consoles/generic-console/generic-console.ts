...
export class GenericConsoleComponent {
  ...
  onUpdateScore() {
    ...
    this.competitionService
      .updateMatch(this.workspaceId, this.eventId, this.competitionId, this.stageId, this.match.id, payload)
      .subscribe({
        next: (updated) => {
  ...
  async onStartMatch() {
    ...
    if (!confirmed) return;
    this.competitionService
      .updateMatch(this.workspaceId, this.eventId, this.competitionId, this.stageId, this.match.id, { status: 'live' })
      .subscribe({
