...
const CLASS_MAP: Record<string, string> = {
  ...
  upcoming:
    'text-[10px] font-bold px-2 py-0.5 bg-violet-500/10 text-violet-400 rounded-md border border-violet-500/20',
};
...
@Pipe({ name: 'eventStatusBadge', standalone: true })
export class EventStatusBadgePipe implements PipeTransform {
