...
import { WorkspaceService, AuditLog } from '../../../workspaces/services/workspace.service';
...
export class AuditLogsComponent implements OnInit {
  ...
  async onClearAuditLogs() {
    const confirmed = await this.uiService.confirm({
      ...
      message:
        'Are you sure you want to clear all recorded audit logs? This action cannot be undone.',
